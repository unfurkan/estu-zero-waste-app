...
List<S2Choice<String>> days = [
  S2Choice<String>(value: 'mon', title: 'Pazartesi'),
  S2Choice<String>(value: 'tue', title: 'Salı'),
  S2Choice<String>(value: 'wed', title: 'Çarsamba'),
  S2Choice<String>(value: 'thu', title: 'Perşembe'),
  S2Choice<String>(value: 'fri', title: 'Cuma'),
  S2Choice<String>(value: 'sat', title: 'Cumartesi'),
  S2Choice<String>(value: 'sun', title: 'Pazar'),
];
...
List<S2Choice<String>> frameworks = [
  S2Choice<String>(value: '0', title: 'Ev Arkadaşım ya da oda arkadaşım yok'),
...
List<Map<String, String>> transports = [
  ...
  {
    'title': 'Özel Araç',
    'image': 'assets/image/private-car.png',
    'value': '1',
    'factor': '1',
  },
  {
    'title': 'Motorsiklet',
    'image': 'assets/image/motorbike.png',
    'value': '2 ',
    'factor': '67.2',
  },
  {
    'title': 'Bisiklet',
    'image': 'assets/image/bicycle.png',
    'value': '3',
    'factor': '1',
  },
...
List<S2Choice<String>> vehicleType = [
  S2Choice<String>(value: '156', title: 'Dizel'),
  S2Choice<String>(value: '179', title: 'Benzin'),
  S2Choice<String>(value: '168', title: 'LPG'),
];


List<S2Choice<String>> distance = [
  S2Choice<String>(value: '2', title: '0-4'),
  S2Choice<String>(value: '6', title: '4-8'),
  S2Choice<String>(value: '10', title: '8-12'),
  S2Choice<String>(value: '14', title: '12-16'),
];
List<S2Choice<String>> plasticBootles = [
  ...
  S2Choice<String>(value: '6', title: '5+'),
];

List<S2Choice<String>> alBootles = [
  S2Choice<String>(value: '0', title: '0'),
  S2Choice<String>(value: '1', title: '1'),
  S2Choice<String>(value: '2', title: '2'),
  S2Choice<String>(value: '3', title: '3'),
...
List<S2Choice<String>> fastFoods = [
  S2Choice<String>(value: '0', title: '0'),
  S2Choice<String>(value: '1', title: '1'),
  S2Choice<String>(value: '2', title: '2'),
  S2Choice<String>(value: '3', title: '3'),
...
List<S2Choice<String>> cartoonGlass = [
  S2Choice<String>(value: '0', title: '0'),
  S2Choice<String>(value: '1', title: '1'),
  S2Choice<String>(value: '2', title: '2'),
  S2Choice<String>(value: '3', title: '3'),
...
List<S2Choice<String>> recycleOptions = [
  S2Choice<String>(value: 'plastic', title: 'Plastic'),
  S2Choice<String>(value: 'glass', title: 'Glass'),
  S2Choice<String>(value: 'al', title: 'Al'),
  S2Choice<String>(value: 'cartoon', title: 'Cartoon'),
];

List<S2Choice<String>> electricBill = [
  S2Choice<String>(value: '75', title: '0-100'),
  S2Choice<String>(value: '150', title: '100-200'),
  S2Choice<String>(value: '250', title: '200-300'),
  S2Choice<String>(value: '350', title: '300-400'),
  S2Choice<String>(value: '450', title: '400-500'),
  S2Choice<String>(value: '550', title: '500-600'),
  S2Choice<String>(value: '650', title: '600-700'),
  S2Choice<String>(value: '700', title: '700+'),
];

List<S2Choice<String>> modalOptions = [
  S2Choice<String>(value: '0', title: 'Evet'),
  S2Choice<String>(value: '1', title: 'Hayır'),
];
